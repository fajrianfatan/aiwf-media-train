        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="{{ route('users.store') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="name" id="name" autocomplete="Salman" required
            ...
            <p class="mt-10 text-center text-sm/6 text-gray-500">
                Not a member?
                <button type="submit" class="btn btn-success font-semibold text-indigo-600 hover:text-indigo-500">Start
                    a 14 day free trial</button>
            </p>
        </div>
    </div>
</body>
